      ...
      <div className="flex-1 flex flex-col items-center justify-center">
        <div className="w-full max-w-sm">
          ...
          <div className="mb-6 text-center">
            <h2 className="text-lg font-medium text-gray-900">Sign up to see photos and videos from your friends.</h2>
          </div>
          
          <button className="w-full flex items-center justify-center space-x-2 py-3 bg-blue-500 text-white rounded-md">
